...
void FFT_2D_Double(double *input_real , double *input_imag , double *output_real , double *output_imag , int length){
...
//   FFT_2D_Double(input_real , input_imag , output_real , output_imag , length);
